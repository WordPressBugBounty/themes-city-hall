...
class city_hall_notice_upgrade extends city_hall_notice {
	...
	public function upgrade_notice() {
		...
		$this_notice_was_dismissed = $this->get_notice_status('upgrade-cityhall');
	...
	public function upgrade_notice_markup() {
		...
		$dismiss_url = wp_nonce_url(
			remove_query_arg( array( 'activated' ), add_query_arg( 'city-hall-hide-notice', 'upgrade-cityhall' ) ),
